...
import styles from './EventCarouselCard.module.css';
...
const EventCarouselCard: React.FC<EventCarouselCardProps> = ({
  eventId,
  ...
  // Error or deleted event - return null to hide from carousel
  if (error || !event) {
    return null;
  }
